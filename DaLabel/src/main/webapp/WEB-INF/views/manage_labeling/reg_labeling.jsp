...
<body class="u-body u-xl-mode">
	<section class="u-align-center u-clearfix u-section-1 u-grey-5"
		id="sec-de29">
		<div class="u-clearfix u-sheet u-sheet-1">
			<div class="member-info-form member-info-form-1">
				<form action="reg.needlogin.labeling.do" method="post"
					onsubmit="return json_()" style="padding: 10px" name="form">
					<div class="u-form-group u-form-name u-label-none">
						<input type="hidden" name="project_bundle_no"
							value="${bundle_no }">
					</div>
					<div class="u-align-left u-form-group u-form-name u-label-none">
					...
					<div class="u-form-group u-form-select u-label-none u-form-group-3">
						<label for="select-8e37" class="u-label">데이터 타입</label> <span
							class="u-form-select-wrapper" id="bundle_data_type"> <select
						...
						</select> <select name="project_how" id="project_how"
							class="u-input u-input-rectangle select-8e37"
							onchange="select();">
